...
That setup was costing several hundred per month and my tiny blog didn't need anywhere close to that kind of setup. I saw a $14/year VPS offer on [LowEndBox](https://lowendbox.com/) from [Secure Dragon](https://securedragon.net/) that included:
...
This blog however is hosted on a [Vultr's](https://www.vultr.com/) *sandbox* 512MB cloud server. I like cloud servers. The ability to spin up a test instance and destroy it and only pay for the time used is super handy. When I checked out Rackspace again, their [cheapest instance](https://www.rackspace.com/en-us/openstack/public/pricing) (at 1GB RAM) was ~$27 a month. I compared all the [top cloud hosting providers](http://www.servermom.org/low-end-cloud-server-providers/) these days and while I liked [DigiatalOcean](https://www.digitalocean.com) and [Linode](https://www.linode.com/), the 15 locations worldwide, spanning North America, Europe, Asia and Australia and the cheap $2.50/month (limit of 2) servers is the reason I went with Vultr. 

Back in Knight's Adventure days, I used the [Cherokee Web Server](http://cherokee-project.com/), but it doesn't look to be actively maintained and I've switched over to [Nginx](https://www.nginx.com/). I did set up SSL using [Let's Encrypt](https://letsencrypt.org/) and will more than likely put up a blog post about that as I ran into a couple of problems.
